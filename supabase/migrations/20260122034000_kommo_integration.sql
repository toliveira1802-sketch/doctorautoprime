...
-- =====================================================
-- 6. TRIGGER PARA SINCRONIZAÇÃO AUTOMÁTICA (OPCIONAL)
-- =====================================================
-- Descomente para ativar sincronização automática

-- CREATE OR REPLACE FUNCTION sync_os_to_kommo()
-- RETURNS TRIGGER AS $$
-- BEGIN
--     -- Adiciona à fila de sincronização
--     INSERT INTO kommo_sync_queue (os_id, action)
--     VALUES (NEW.id, 'sync_os_to_lead');
--     
--     RETURN NEW;
-- END;
-- $$ LANGUAGE plpgsql;
...
--     FOR EACH ROW
--     EXECUTE FUNCTION sync_os_to_kommo();
