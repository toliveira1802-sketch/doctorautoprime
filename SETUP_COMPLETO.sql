...
-- Roles (separado de profiles por seguranÃ§a)
...
CREATE TABLE public.promotions (
  ...
  title TEXT NOT NULL,
  description TEXT,
  discount_label TEXT NOT NULL, -- "30% OFF", "GRÃTIS"
  discount_percent INTEGER NOT NULL DEFAULT 0,
  valid_from DATE NOT NULL,
  valid_to DATE NOT NULL,
  vehicle_models TEXT[] DEFAULT '{}', -- Modelos elegÃ­veis (vazio = todos)
  service_id UUID REFERENCES public.services(id) ON DELETE SET NULL,
  available_dates DATE[] DEFAULT '{}', -- Datas especÃ­ficas disponÃ­veis
  is_active BOOLEAN NOT NULL DEFAULT true,
  created_at TIMESTAMPTZ NOT NULL DEFAULT now(),
  updated_at TIMESTAMPTZ NOT NULL DEFAULT now()
);
...
-- ServiÃ§os do agendamento (muitos-para-muitos)
...
-- Registro de interesse (quando nÃ£o hÃ¡ promoÃ§Ãµes)
...
-- =============================================
-- 5. FUNÃ‡ÃƒO PARA VERIFICAR ROLE (SECURITY DEFINER)
-- =============================================
...
-- USER_ROLES (sÃ³ admins podem ver/modificar)
...
-- PROMOTIONS (leitura pÃºblica para ativas, escrita admin)
...
-- EVENTS (leitura pÃºblica para ativos, escrita admin)
...
-- TRACKING (usuÃ¡rio pode inserir, admin pode ver tudo)
